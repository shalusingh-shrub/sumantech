...
<?php $__env->startSection('page-title', 'Certificate Builder'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('admin.awards.participants', $award)); ?>" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>

<?php if(session('success')): ?>
<div class="alert alert-success alert-dismissible py-2"><button type="button" class="btn-close" data-bs-dismiss="alert"></button><i class="fas fa-check-circle me-2"></i><?php echo e(session('success')); ?></div>
<?php endif; ?>

<?php if(!$award->certificate_template): ?>
<div class="alert alert-warning"><i class="fas fa-exclamation-triangle me-2"></i>Pehle certificate template upload karo — <a href="<?php echo e(route('admin.awards.edit', $award)); ?>">Edit Award</a></div>
<?php else: ?>
...
<div class="left-panel">
    ...
    <div class="panel-card">
        ...
        <button class="elem-btn" onclick="addText('award_title', <?php echo json_encode($award->title, 15, 512) ?>)"><i class="fas fa-trophy text-danger fa-fw"></i>Award Title</button>
    ...
    <div class="panel-card">
        ...
        <form action="<?php echo e(route('admin.awards.saveCertLayout', $award)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<div class="right-panel">
    <div class="panel-card">
        ...
        <div class="cert-canvas" id="certCanvas">
            <img src="<?php echo e($award->certificate_url); ?>" id="certBg" class="cert-bg" crossorigin="anonymous" onerror="this.onerror=null;this.style.opacity='.3'">
        </div>
    </div>
</div>
</div>
...
window.addEventListener('load', function() {
    var saved = <?php echo json_encode(json_decode($award->cert_layout, true), 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ROHIT RAJ\Herd\tob\resources\views/admin/awards/certificate_builder.blade.php ENDPATH**/ ?>