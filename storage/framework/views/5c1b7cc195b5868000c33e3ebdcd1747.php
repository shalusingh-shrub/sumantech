                ...
                <div class="mb-3">
                    ...
                    <div class="captcha-box mb-2">
                        <div class="captcha-img-wrap">
                            <img src="<?php echo e(route('captcha.image')); ?>" id="captchaImg" alt="CAPTCHA" style="height:45px;display:block;">
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center mt-3 mb-0" style="font-size:14px;">
                New user? <a href="<?php echo e(route('register')); ?>" style="color:#1a2a6c;font-weight:600;"><i class="fas fa-user-plus me-1"></i>Register Here</a>
            </p>
            <hr>
            <div class="text-center">
                <a href="<?php echo e(route('home')); ?>" style="color:#1a2a6c;font-size:13px;"><i class="fas fa-arrow-left me-1"></i>Back to Website</a>
            </div>
        </div>
    </div>
</div>
...
function refreshCaptcha() {
    ...
    img.src = "<?php echo e(route('captcha.image')); ?>?v=" + Math.random();
...
<?php /**PATH C:\Users\ROHIT RAJ\Herd\tob\resources\views/auth/login.blade.php ENDPATH**/ ?>