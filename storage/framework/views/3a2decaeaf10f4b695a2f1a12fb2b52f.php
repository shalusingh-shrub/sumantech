...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Teachers of Bihar - The Change Makers'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Teachers of Bihar - A voluntary organization of government school teachers working to improve education quality in Bihar.'); ?>">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>"><i class="fas fa-user me-1"></i>User Login</a>
                <?php else: ?>
                    <a href="<?php echo e(auth()->user()->hasRole('super_admin') || auth()->user()->hasRole('admin') ? route('admin.dashboard') : '#'); ?>" class="me-3"><i class="fas fa-tachometer-alt me-1"></i>Dashboard</a>
...
<div class="site-header">
    <div class="container">
        <div class="d-flex align-items-center">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Teachers of Bihar" height="70" class="me-3" onerror="this.style.display='none'">
            <div class="logo-text">
...
<nav class="main-nav navbar navbar-expand-lg">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link <?php echo e(request()->is('/') ? 'active' : ''); ?>" href="<?php echo e(route('home')); ?>">Home</a></li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">About Us</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('about')); ?>">About ToB</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('bagless-saturday')); ?>">Bagless Saturday</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('lets-talk')); ?>">Let's Talk</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('shiksha-shriti')); ?>" class="hindi-text">Shiksha Shruti</a></li>
                    </ul>
                </li>
                    ...
                    <div class="dropdown-menu mega-menu">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <a class="mega-link hindi-text" href="<?php echo e(route('science-corner')); ?>">विज्ञान कार्नर</a>
                                <a class="mega-link hindi-text" href="<?php echo e(route('anusandhaanam')); ?>">अनुसंधानम्</a>
                                <a class="mega-link" href="<?php echo e(route('tlm')); ?>">TLM</a>
                                <a class="mega-link" href="<?php echo e(route('eresources')); ?>">e-Resources</a>
                            </div>
                            <div class="col-md-3">
                                <div class="mega-col-title">Magazines</div>
                                <a class="mega-link hindi-text" href="<?php echo e(route('emagazine')); ?>">ई-मैगजीन</a>
                                <a class="mega-link hindi-text" href="<?php echo e(route('abhimat')); ?>">अभिमत</a>
                                <a class="mega-link hindi-text" href="<?php echo e(route('karmana')); ?>">कर्मणा</a>
                            </div>
                            <div class="col-md-3">
                                <div class="mega-col-title">For Students</div>
                                <a class="mega-link hindi-text" href="<?php echo e(route('balman')); ?>">बाल मन</a>
                                <a class="mega-link hindi-text" href="<?php echo e(route('suvichar')); ?>">सुविचार</a>
                            </div>
                            <div class="col-md-3">
                                <div class="mega-col-title">Online</div>
                                <a class="mega-link" href="https://teachersofbihar.blogspot.com/" target="_blank">Blog</a>
                                <a class="mega-link" href="<?php echo e(route('shiksha-shriti')); ?>">Shiksha Shruti</a>
                                <a class="mega-link" href="<?php echo e(route('podcast')); ?>">Podcast</a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('project-shikshak-sathi')); ?>">
                        <img src="<?php echo e(asset('images/new-badge.gif')); ?>" alt="new" width="18" onerror="this.style.display='none'">
                        Project Shikshak Sathi
                    </a>
                </li>

                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('news-events')); ?>">News &amp; Events</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('eip')); ?>">EIP</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('competition')); ?>">Competition</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('award')); ?>">Award</a></li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Gallery</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('image-gallery')); ?>">Image Gallery</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('video-gallery')); ?>">Video Gallery</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('media')); ?>">Media</a></li>
                    </ul>
                </li>

                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('testimonials')); ?>">Testimonial</a></li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Contact</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('contact')); ?>">Contact</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('suggestion-box')); ?>">
                            <img src="<?php echo e(asset('images/new-badge.gif')); ?>" alt="new" width="18" onerror="this.style.display='none'">
                            Suggestion Box</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('your-opinion')); ?>">Your Opinion</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<!-- Top Flash Marquee -->
<?php $topFlashes = App\Models\TopFlash::where('is_active', true)->orderBy('sort_order')->get(); ?>
<?php if($topFlashes->count() > 0): ?>
<div class="top-flash">
    <div class="container">
        <div class="d-flex align-items-center">
            <span class="flash-label">Flash News</span>
            <marquee behavior="scroll" direction="left" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
                <?php $__currentLoopData = $topFlashes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($flash->is_new): ?>
                        <img src="<?php echo e(asset('images/new-badge.gif')); ?>" alt="new" class="new-gif" onerror="this.style.display='none'">
                    <?php endif; ?>
                    <a href="<?php echo e($flash->link ?: '#'); ?>" target="<?php echo e($flash->link && $flash->link !== '#' ? '_blank' : '_self'); ?>"><?php echo e($flash->title); ?></a>
                    &nbsp;|&nbsp;
...
<footer class="site-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 mb-4">
                ...
                <a href="<?php echo e(route('news-events')); ?>">News & Events</a>
                <a href="<?php echo e(route('testimonials')); ?>">Testimonials</a>
                <a href="<?php echo e(route('contact')); ?>">Contact</a>
            </div>
            <div class="col-md-3 mb-4">
                <h5>Publications</h5>
                <a href="<?php echo e(route('science-corner')); ?>" class="hindi-text">विज्ञान कार्नर</a>
                <a href="<?php echo e(route('tlm')); ?>">TLM</a>
                <a href="<?php echo e(route('emagazine')); ?>" class="hindi-text">ई-मैगजीन</a>
                <a href="<?php echo e(route('balman')); ?>" class="hindi-text">बाल मन</a>
                <a href="<?php echo e(route('suvichar')); ?>" class="hindi-text">सुविचार</a>
                <a href="<?php echo e(route('eresources')); ?>">e-Resources</a>
            </div>
            <div class="col-md-3 mb-4">
                <h5>Contact Info</h5>
                <p style="color:rgba(255,255,255,0.8);font-size:13px;">
    ...
    <div class="footer-bottom">
        <div class="container">
            &copy; <?php echo e(date('Y')); ?> Teachers of Bihar - The Change Makers. All Rights Reserved.
        </div>
    </div>
</footer>
            ...
            <div class="modal-body p-4">
                <div class="row">
                    <div class="col-md-3 text-center mb-3">
                        <img id="memberPhoto" src="<?php echo e(asset('images/default-avatar.png')); ?>" alt="Member Photo" class="member-photo img-fluid">
                    </div>
                    <div class="col-md-9">
...
<?php /**PATH C:\Users\ROHIT RAJ\Herd\tob\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>