@if(!empty($activeInauguration))
    <div
        ...
        data-verify-url="{{ route('front.inauguration.verify', $activeInauguration) }}"
    ...
    >
        ...
        <div class="inauguration-dialog position-{{ $activeInauguration->message_position ?? 'middle' }} align-{{ $activeInauguration->content_align ?? 'center' }}">
            ...
            <div class="inauguration-shade" aria-hidden="true"></div>
    ...
    <style>
        ...
        .inauguration-modal.is-celebrating .inauguration-dialog {
            display: none;
        }
        .inauguration-dialog {
            position: relative;
        ...
        .inauguration-shade {
            ...
            inset: 0;
            /* background:
                linear-gradient(90deg, rgba(8, 20, 32, 0.76), rgba(8, 20, 32, 0.34), rgba(8, 20, 32, 0.76)),
                linear-gradient(0deg, rgba(8, 20, 32, 0.45), rgba(8, 20, 32, 0.18)); */
        }
        ...
        .align-center #inaugurationForm {
            margin-inline: auto;
        }
        .align-right #inaugurationForm {
            margin-left: auto;
        }
        .inauguration-error {
            min-height: 22px;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function playInaugurationApplause(onReady) {
                ...
                function startAnimation() {
                    ...
                    didStart = true;
                    onReady(celebrationDuration);
                }

                audio.addEventListener('loadedmetadata', startAnimation, { once: true });
            ...
            function runInaugurationConfetti(duration) {
                ...
                var animationDuration = Math.max(1800, duration || 5000);
