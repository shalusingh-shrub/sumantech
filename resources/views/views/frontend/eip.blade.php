    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                @if($resource->image)<img src="{{ $resource->image_url }}" class="card-img-top" style="height:180px;object-fit:cover;" onerror="this.onerror=null;this.style.opacity='0.3'">@endif
                <div class="card-body">
