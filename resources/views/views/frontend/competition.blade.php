...
@section('title', 'Competition - Teachers of Bihar')
@section('content')
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius:10px; overflow:hidden;">
                ...
                {{-- Image --}}
                @if($comp->image)
                <img src="{{ $comp->image_url }}" class="card-img-top" style="height:220px; object-fit:cover;" onerror="this.onerror=null;this.style.opacity='0.3'">
                @endif
