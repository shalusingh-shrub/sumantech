...
<div class="row">
    <div class="col-md-8">
        <div class="card border-0 shadow-sm p-4 mb-3" style="border-radius:10px;">
            ...
            <div class="mb-3">
                ...
                <textarea name="content" id="contentEditor" class="form-control" rows="12">{{ old('content', $page->content) }}</textarea>
            </div>
            <div class="mb-3">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm p-4" style="border-radius:10px;">
            ...
            <button type="submit" class="btn btn-tob w-100" style="padding:12px;"><i class="fas fa-save me-2"></i>Update Page</button>
        </div>
    </div>
</div>
</form>
