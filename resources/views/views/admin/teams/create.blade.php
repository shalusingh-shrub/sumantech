...
<head>
    ...
    <title>Add Team Member - Suman Tech</title>
...
<div class="main-content">
    <div class="topbar">
        <h4 style="margin:0;font-size:18px;"><i class="fas fa-user-plus me-2" style="color:#7B3F00;"></i>Add New Team Member</h4>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Shiv Kumar Sinha" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Role</label>
                                    <input type="text" name="role" class="form-control" value="{{ old('role') }}" placeholder="e.g. Teacher, IT Expert">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="contribution" class="form-control" value="{{ old('contribution') }}" placeholder="e.g. Technical Support">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Designation</label>
                                    <input type="text" name="designation" class="form-control" value="{{ old('designation') }}" placeholder="e.g. Middle School Teacher, Nalanda">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="school" class="form-control" value="{{ old('school') }}" placeholder="e.g. MS Rajgir">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Block</label>
                                    <input type="text" name="block" class="form-control" value="{{ old('block') }}" placeholder="e.g. Rajgir">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">District</label>
                                    <input type="text" name="district" class="form-control" value="{{ old('district') }}" placeholder="e.g. Nalanda">
                                </div>
                            </div>
