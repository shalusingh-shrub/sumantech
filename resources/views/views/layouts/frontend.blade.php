            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('project-shikshak-sathi') }}">
                        <img src="{{ asset('images/new-badge.gif') }}" alt="new" width="18" onerror="this.onerror=null;this.style.opacity='0.3'">
        ...
        <div class="d-flex align-items-center">
            ...
            <marquee behavior="scroll" direction="left" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">
                @foreach($topFlashes as $flash)
                    @if($flash->is_new)
                        <img src="{{ asset('images/new-badge.gif') }}" alt="new" class="new-gif" onerror="this.onerror=null;this.style.opacity='0.3'">
                    @endif
