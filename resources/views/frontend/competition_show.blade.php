...
<div class="container py-5">
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('competition') }}">Competition</a></li>
            <li class="breadcrumb-item active">{{ Str::limit($comp->title, 40) }}</li>
        </ol>
    </nav>
    ...
    <div class="row g-4">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm p-4" style="border-radius:10px;">
                @if($comp->image)
                <img src="{{ $comp->image_url }}" class="img-fluid rounded mb-4" style="max-height:400px; width:100%; object-fit:cover;">
                @endif

                <h3 class="fw-bold mb-3" style="color:#1a2a6c;">{{ $comp->title }}</h3>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-4" style="border-radius:10px;">
                ...
                <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <strong>{{ $comp->start_date->format('d M Y') }}</strong>
                </div>
                @endif
                ...
                <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <strong>{{ $comp->end_date->format('d M Y') }}</strong>
                </div>
                @endif
                ...
                <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <strong>{{ $comp->result_date->format('d M Y') }}</strong>
                </div>
                @endif
                ...
                {{-- Buttons --}}
                @if($comp->end_date && $comp->end_date->isFuture() && $comp->registration_link)
                ...
                <a href="{{ route('competition') }}" class="btn btn-outline-secondary w-100">
