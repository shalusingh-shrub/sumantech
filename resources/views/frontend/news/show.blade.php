...
@section('title', $item->title . ' - Teachers of Bihar')
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                @if($item->image)
                <img src="{{ $item->image_url }}" alt="{{ $item->title }}" class="card-img-top" style="max-height:400px;object-fit:cover;" onerror="this.style.display='none'">
                @endif
