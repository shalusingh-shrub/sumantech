    ...
    <div class="col-6 col-md-3">
        <div class="card border-0 shadow-sm p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="fw-bold fs-5">{{ $stats['contacts'] }}</div>
    ...
    <div class="col-6 col-md-3">
        <div class="card border-0 shadow-sm p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="fw-bold fs-5">{{ $stats['suggestions'] }}</div>
    ...
    <div class="col-6 col-md-3">
        <div class="card border-0 shadow-sm p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="fw-bold fs-5">{{ $stats['opinions'] }}</div>
    ...
    <div class="col-6 col-md-3">
        <div class="card border-0 shadow-sm p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="fw-bold fs-5">{{ $stats['gallery'] }}</div>
                ...
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('admin.contacts.show', $contact) }}" class="btn btn-xs btn-sm btn-outline-primary" style="font-size:11px;">View</a></td>
                        </tr>
                        @endforeach
