        ...
        <div class="card data-card mb-3">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $inauguration->title ?? '') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Website Launch">
                ...
                <div class="mb-3">
                    ...
                    @if(isset($inauguration) && $inauguration->poster_path)
                        <div class="mt-2">
                            ...
                            <img src="{{ $inauguration->posterUrl() }}" alt="Current poster" style="width:140px;height:100px;object-fit:cover;border-radius:8px;border:1px solid #ddd;">
                        </div>
                    @endif
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @error('message_position') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        @error('content_align') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div id="selected-route-panel" class="{{ $selectedScope === 'selected' ? '' : 'd-none' }}">
                    ...
                    <div class="mt-3">
                        ...
                        @error('paths') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card data-card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('admin.inaugurations.index') }}" class="btn btn-secondary w-100 mt-2">Cancel</a>
            </div>
        </div>
    </div>
</div>
